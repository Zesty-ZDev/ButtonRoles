const { EmbedBuilder, InteractionType,ButtonBuilder, TextInputStyle, TextInputBuilder, ModalBuilder, ActionRowBuilder, StringSelectMenuBuilder, StringSelectMenuOptionBuilder } = require("discord.js");
...
.setStyle('Success'),
    ...
    interaction.update({components:[controlpanelrow]});        
      }
      else{
      const controlpanelrow = new ActionRowBuilder()
    .addComponents(
...
if (interaction.isStringSelectMenu()){
    if (interaction.customId == 'selectcolor1') {
        if (interaction.values == "gray") {global.color1 = 'Secondary'}
        if (interaction.values == "green") {global.color1 = 'Success'}
        if (interaction.values == "red") {global.color1 = 'Danger'}
        if (interaction.values == "blurple") {global.color1 = 'Primary'}
        interaction.update({components:[], content:"Color Selected", ephemeral:true})
    }}
...
interaction.update({embeds:[updatepanelsend1], components:[]})
interaction.channel.send({embeds:[panelsend1], components:[panelsendbutton1]})
...
interaction.update({embeds:[controlpanel2], components:[controlpanelrow2]})
}
} 
...
if (interaction.values == "gray") {global.color2 = 'Secondary'}
if (interaction.values == "green") {global.color2 = 'Success'}
if (interaction.values == "red") {global.color2 = 'Danger'}
if (interaction.values == "blurple") {global.color2 = 'Primary'}
interaction.update({components:[], content:'Color Selected'})
}}
...
if (interaction.values == "gray") {global.color3 = 'Secondary'}
if (interaction.values == "green") {global.color3 = 'Success'}
if (interaction.values == "red") {global.color3 = 'Danger'}
if (interaction.values == "blurple") {global.color3 = 'Primary'}
interaction.update({components:[], content:'Color Selected'})
}}
...
if (interaction.values == "gray") {global.color4 = 'Secondary'}
if (interaction.values == "green") {global.color4 = 'Success'}
if (interaction.values == "red") {global.color4 = 'Danger'}
if (interaction.values == "blurple") {global.color4 = 'Primary'}
interaction.update({components:[], content:'Color Selected'})
}}
...
if (interaction.values == "gray") {global.color5 = 'Secondary'}
if (interaction.values == "green") {global.color5 = 'Success'}
if (interaction.values == "red") {global.color5 = 'Danger'}
if (interaction.values == "blurple") {global.color5 = 'Primary'}
interaction.update({components:[], content:'Color Selected'})
}}
